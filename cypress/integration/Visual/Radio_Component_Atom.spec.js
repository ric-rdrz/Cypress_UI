...
describe('Visual Tests Radio Component', () => {
  before(() => {
    ...
    Menu.elementSelect('Radio');
  });

  it('Radio Functionality in Playground DS', () => {
    cy.fixture('/DesignSystem/radio.txt').then((data) => {
      Menu.fillDataPlaygroundSingle(data);
      RadioPage.radioPlayground();
    });
    cy.percySnapshot('Radio');
  });

  it('Radio Override Functionality in Playground DS', () => {
    cy.fixture('/DesignSystem/OverrideStyles/radio.txt').then((data) => {
      Menu.fillDataPlaygroundSingle(data);
    });
    cy.percySnapshot('Radio_override');
  });
});
