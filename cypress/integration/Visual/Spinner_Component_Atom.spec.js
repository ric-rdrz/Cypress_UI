...
describe('Visual Tests Spinner Component', () => {
  before(() => {
    ...
    Menu.elementSelect('Spinner');
  });

  it('Text Component in Playground DS', () => {
    cy.fixture('/DesignSystem/spinner.txt').then((data) => {
      Menu.fillDataPlaygroundSingle(data);
      SpinnerPage.spinnerPlayground();
      cy.percySnapshot('spinner');
    });
  });
});
